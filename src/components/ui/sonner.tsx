...
const Toaster = ({ ...props }: ToasterProps) => {
  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast: "!py-5 !px-6 !text-base !gap-4 !pointer-events-auto",
          title: "!text-base !font-medium",
          description: "!text-sm",
          closeButton: "!bg-background !border-border hover:!bg-muted !size-8 !right-2 !top-2 [&>svg]:!size-4 !pointer-events-auto !z-[10000]",
